...
func TestHandshakeClientPSKAES(t *testing.T) {
	var config = *testConfig
	config.CipherSuites = []uint16{TLS_PSK_WITH_AES_128_CBC_SHA}
	testClientScript(t, "PSK-AES", pskAESClientScript, &config)
}
